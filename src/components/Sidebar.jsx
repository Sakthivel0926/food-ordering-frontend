...
const Sidebar = ({ isCollapsed, toggleSidebar, isZoomed, isDrawerMode, onNavigate }) => {
  ...
  const menuItems = [
    ...
    { name: "My Orders", path: "/orders", icon: <Package size={22} /> },
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="sidebar-header flex items-center justify-between h-16 px-4 border-b border-[#2A2A2A] sticky top-0 bg-[#0e0e0e] z-10">
