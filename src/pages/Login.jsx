...
const Login = () => {
  ...
  const [showPassword, setShowPassword] = useState(false); // ✅ Fix: Added state
  ...
  return (
    <div
      ...
      } flex items-center justify-center min-h-screen p-4 transition-all bg-cover bg-center`}
      style={{
    ...
    >
      <motion.div
        ...
        } p-8 rounded-lg shadow-lg w-full max-w-md transition-all backdrop-blur-md bg-opacity-90`}
      >
